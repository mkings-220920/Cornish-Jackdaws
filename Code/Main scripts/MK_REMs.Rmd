...
#Note, to run this model a dataframe of REM covariates ('covars', line 329) is required; this is due to an issue with calculating the time-varying covariates 'source.isgroupA' and 'target.isgroupA' using Eventnet. The 'covars' dataset can be accessed from the combined raw data file ('DB_REM_INPUT), as is the case in the MK_permutations.R script (see line 17).
