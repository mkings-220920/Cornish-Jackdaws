...
```{r}
feed_dir<-"C:\\Users\\Mike\\Documents\\DB_experiments\\Data4"
...
Remove individuals that don't have a treatment group assignment, also remove those that might have had the wrong group label (37 events) due to RFID code duplication or input error, and then output the final REM dataset in Eventnet format
